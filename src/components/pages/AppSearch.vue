      ...
      <aside class="px-sm-3 px-md-4 px-lg-5 py-5">
        ...
        <div class="filters-form my-4">
          <div class="price">
            ...
            <input class="form-control" type="number" id="price" v-model.number="currentPrice" min="0" placeholder="€" />

            <!-- range bar-->

            <input type="range" class="priceSlider my-3" min="0" max="1000" v-model="currentPrice" />
            <!-- <p>
