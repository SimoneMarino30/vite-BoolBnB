      ...
      <nav class="navbar navbar-expand-lg">
        <div class="container-fluid text-center">
          <a class="navbar-brand" href="/">
            <img src="../../assets/images/logo-prova.png" alt="Logo" class="d-inline-block align-text-top logo" />
          </a>
          ...
          <div class="collapse navbar-collapse justify-content-between" id="navbarScroll">
            ...
            <!-- buttons -->
            <div v-if="store.user_email === ''" class="d-flex align-items-center text-center justify-content-center">
              <a href="http://127.0.0.1:8000/login">
                <button class="nav-btn">Login</button>
              </a>
              <span class="fs-3">|</span>

              <a href="http://127.0.0.1:8000/register"><button class="nav-btn">Registrati</button>
              </a>
              <!-- Dropdown LINGUA -->
              <div class="dropdown">
            ...
            <div v-else class="d-flex align-items-center text-center justify-content-center">
              <div class="dropdown">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li>
                    <button @click="logout()" id="logout_button" type="button" class="dropdown-item">Logout</button>
                  </li>
                </ul>
              </div>
            </div>
